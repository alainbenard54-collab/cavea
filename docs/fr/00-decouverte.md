...
### Réinitialisation des données uniquement — Windows et Linux

Si vous souhaitez conserver vos paramètres (mode, chemin de la cave) mais repartir d'une cave vide :
