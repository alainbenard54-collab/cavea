...
3. `docs/en/README.md` — full index in English only, listing the 13 scenarios with relative links to `en/NN-slug.md` files. Served by GitHub Pages at `https://cavea.abapps.fr/en/`.
