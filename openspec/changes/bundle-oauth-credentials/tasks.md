...
- [x] 6.3 Test Android : builder l'APK avec `assets/secrets/dropbox_app_key.txt` présent, vérifier que le wizard Dropbox ne demande plus l'App Key et que l'auth PKCE fonctionne — Validé 2026-05-26 (Dropbox PKCE sans saisie App Key ✅)
- [x] 6.4 Test Linux : relancer `build_linux.sh deb` avec les JSON à la racine, installer le .deb, vérifier que les JSON sont dans `/usr/local/lib/cavea/` et que le Mode 2 fonctionne directement — Validé 2026-05-26 (Drive + Dropbox)
