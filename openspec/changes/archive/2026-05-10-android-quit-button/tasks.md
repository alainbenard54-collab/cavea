...
- [x] 5.1 Tester "Sauvegarder" : upload effectif sur Drive, lock conservé, snackbar "Cave sauvegardée sur Drive", app reste en mode écriture (Android Mode 2)
- [x] 5.2 Tester "Quitter" : dialog de confirmation s'ouvre, annuler → rien, confirmer → overlay "Sauvegarde en cours…", upload Drive, lock libéré, app fermée (Android Mode 2)
- [x] 5.3 Tester que "Quitter" est absent en mode lecture seule et en Mode 1 (Android)
- [x] 5.4 Vérifier visuellement que les 3 boutons (Retour lecture seule + Sauvegarder + Quitter) tiennent correctement dans la zone sync sur petit écran Android
