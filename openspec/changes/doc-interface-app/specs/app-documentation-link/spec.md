...
- langue `en` → `https://alainbenard54-collab.github.io/cavea/en/`
- toute autre langue (dont `fr`) → `https://alainbenard54-collab.github.io/cavea/fr/`
...
- **THEN** le navigateur externe s'ouvre sur `https://alainbenard54-collab.github.io/cavea/fr/`
...
- **THEN** le navigateur externe s'ouvre sur `https://alainbenard54-collab.github.io/cavea/en/`
